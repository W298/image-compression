...
std::vector<std::vector<unsigned char>> extract_block(unsigned char** image, int x, int y) {
...
double average(std::vector<std::vector<unsigned char>>& block) {
    double sum = 0.0;
    for (int i = 0; i < 8; i++)
        for (int j = 0; j < 8; j++)
            sum += block[i][j];
...
double variance(std::vector<std::vector<unsigned char>>& block, double avg) {
    double var = 0.0;
    for (int i = 0; i < 8; i++)
        for (int j = 0; j < 8; j++)
...
double covariance(std::vector<std::vector<unsigned char>>& block1, std::vector<std::vector<unsigned char>>& block2, double avg1, double avg2) {
    double cov = 0.0;
    for (int i = 0; i < 8; i++)
        for (int j = 0; j < 8; j++)
...
double ssim(std::vector<std::vector<unsigned char>>& block1, std::vector<std::vector<unsigned char>>& block2) {
...
double compute_ssim(unsigned char** image1, unsigned char** image2, int width, int height) {
